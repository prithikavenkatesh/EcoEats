//
//  LearnMoreAboutFoodWasteView .swift
//  EcoEats
//
//  Created by Noga Gercsak on 7/31/23.
//

import SwiftUI
struct LearnMoreAboutFoodWasteView: View {
    var body: some View {
        ZStack {
            Group {
...
struct LearnMoreAboutFoodWasteView_Previews: PreviewProvider {
    static var previews: some View {
        LearnMoreAboutFoodWasteView()
    }
}
